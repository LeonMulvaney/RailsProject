...
class PrescriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prescription" do
    assert_difference('Prescription.count') do
      post prescriptions_url, params: { prescription: { date: @prescription.date, duration: @prescription.duration, follow_up: @prescription.follow_up, frequency: @prescription.frequency, medication_name: @prescription.medication_name, patient_name: @prescription.patient_name, special_instructions: @prescription.special_instructions, strength: @prescription.strength } }
    end
  ...
  test "should update prescription" do
    patch prescription_url(@prescription), params: { prescription: { date: @prescription.date, duration: @prescription.duration, follow_up: @prescription.follow_up, frequency: @prescription.frequency, medication_name: @prescription.medication_name, patient_name: @prescription.patient_name, special_instructions: @prescription.special_instructions, strength: @prescription.strength } }
